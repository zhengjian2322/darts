...
# ('sep_conv_xxxx', x),sep_conv_xxxxb  represents operation ，x represents which node input
# normal_concat: all the nodes(except original input) as the input to the output node
DARTS_V2 = Genotype(
